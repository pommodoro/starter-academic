  ...
  - block: markdown
    ...
    content:
      ...
      text: |
        ...
        **<a href="https://www.dropbox.com/scl/fi/ouxaflaebsar91t1s1b79/rpm_jmp_live.pdf?rlkey=r9yoevzo9hadq1ob1hho0tsyu&raw=1
        "> Information Frictions and the Market for Climate Adaptation: Evidence from Index Insurance in Colombia** <a> <em>(Job Market Paper)</em>  
        <div class="abstract" style="font-size:0.95rem;font-style:italic;font-weight:400;line-height:1.45;margin:0.35rem 0.75rem 0.55rem;opacity:.88;">
          I study why take-up of rainfall index insurance remains low despite high theoretical value: are choices constrained by cognitive frictions—difficulty mapping contract terms into product quality—or by low average trust in insurers? I extend a neuroeconomic framework to separate these channels and test them in a framed field experiment with smallholder coffee farmers in Cauca, Colombia. Participants make incentivized choices over contracts that orthogonally vary (i) payout probability and (ii) covariance with farm income, holding all else fixed. At baseline, demand is weakly responsive to quality: about 66% of farmers show low elasticity; over 10% buy contracts with near-zero payout probability; and 25% reject contracts with near-certain payouts. I then randomize two treatments. A climate-literacy treatment—personal rain gauges, 15 days of real-time rainfall tracking, and historical rainfall–income correlations—increases quality responsiveness by ~50% and sharpens the mapping from true to perceived probabilities. An advertising treatment using real insurer materials leaves responsiveness unchanged and reduces average demand by >10%, consistent with low reputation rather than improved evaluation. A simple two-period model with cognitive frictions rationalizes these facts: limited responsiveness makes low quality profitable early, erodes reputation, and can “poison” the market. Improving signal precision, not persuasion, is thus key for durable adoption and market viability.
        </div>
